...
Perror_t tree_m_rec_init (P_t *,tree_m *,Pbase_m);
Perror_t tree_read (P_t *,tree_m *,tree_pd *,tree *);
int tree_verify (P_t *,tree *);
int tree_genPD (P_t *,tree *,tree_pd *);
Perror_t tree_acc_init (P_t *,tree_acc *);
Perror_t tree_acc_reset (P_t *,tree_acc *);
Perror_t tree_acc_cleanup (P_t *,tree_acc *);
Perror_t tree_acc_add (P_t *,tree_acc *,tree_pd *,tree *);
Perror_t tree_acc_report2io (P_t *,Sfio_t *,char const *,char const *,int,tree_acc *);
Perror_t tree_acc_report (P_t *,char const *,char const *,int,tree_acc *);
Perror_t tree_acc_report2xml_io (P_t *,Sfio_t *,int,tree_acc *);
...
ssize_t tree_fmt2buf_final (P_t *,Pbyte *,size_t,int *,int *,char const *,tree_m *,tree_pd *,tree *);
ssize_t tree_fmt2buf (P_t *,Pbyte *,size_t,int *,int *,char const *,tree_m *,tree_pd *,tree *);
ssize_t tree_fmt2io (P_t *,Sfio_t *,int *,char const *,tree_m *,tree_pd *,tree *);
...
Perror_t tip_t_m_rec_init (P_t *pads,tip_t_m *mask,Pbase_m baseMask);

Perror_t tip_t_read (P_t *pads,tip_t_m *m,tip_t_pd *pd,tip_t *rep);

int tip_t_verify (P_t *pads,tip_t *rep);
...
Perror_t inode_m_rec_init (P_t *pads,inode_m *mask,Pbase_m baseMask);

Perror_t inode_read (P_t *pads,inode_m *m,inode_pd *pd,inode *rep);

int inode_verify (P_t *pads,inode *rep);
...
Perror_t branches_t_m_rec_init (P_t *pads,branches_t_m *mask,Pbase_m baseMask);
...
int branches_t_verify (P_t *pads,branches_t *rep);
...
Perror_t _tree_m_rec_init (P_t *pads,_tree_m *mask,Pbase_m baseMask);

Perror_t _tree_read (P_t *pads,_tree_m *m,_tree_pd *pd,_tree *rep);

int _tree_verify (P_t *pads,_tree *rep);
...
Perror_t tree_m_rec_init (P_t *pads,tree_m *mask,Pbase_m baseMask);

Perror_t tree_read (P_t *pads,tree_m *m,tree_pd *pd,tree *rep);

int tree_verify (P_t *pads,tree *rep);
