#ifndef __STRACE_JACCN_DAT2__H__
#define __STRACE_JACCN_DAT2__H__
#include "pads.h"
...
struct param_t_m_s {
  ...
  paren_t_m v_paren;		/* nested constraints */
...
union message_t_pd_u_u {
  unfinished_t_pd v_unfinished_msg;
  resumed_t_pd v_resumed_msg;
...
struct message_t_m_s {
  Pbase_m compoundLevel;
  unfinished_t_m v_unfinished_msg;		/* nested constraints */
  resumed_t_m v_resumed_msg;		/* nested constraints */
...
struct message_t_acc_s {
  Pint32_acc tag;
  unfinished_t_acc v_unfinished_msg;
  resumed_t_acc v_resumed_msg;
...
#endif /*  __STRACE_JACCN_DAT2__H__  */
