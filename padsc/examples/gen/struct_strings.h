#ifndef __STRUCT_STRINGS__H__
#define __STRUCT_STRINGS__H__
#include "pads.h"
...
struct test_m_s {
  ...
  Pbase_m s1_con;		/* struct constraints */
  Pbase_m s2;		/* nested constraints */
  Pbase_m s2_con;		/* struct constraints */
};
struct test_pd_s {
  Pflags_t pstate;
  Puint32 nerr;
...
struct test_acc_s {
  Puint32_acc nerr;
  Pstring_acc s1;		/* (s1.str)[0] == x&& */
  Pstring_acc s2;		/* (s2.len) == 7&& */
};
