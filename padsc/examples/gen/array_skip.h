#ifndef __ARRAY_SKIP__H__
#define __ARRAY_SKIP__H__
#include "pads.h"
...
Pread_res_t seq_t_final_checks (P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep,Ploc_t *loc_ptr,int consume);
