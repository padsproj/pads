#ifndef __PTIME_EXPLICIT__H__
#define __PTIME_EXPLICIT__H__
#include "pads.h"
...
struct threetimes_acc_s {
  Puint32_acc nerr;
  Ptime_explicit_acc time1;
  Ptime_explicit_acc time2;
  Ptime_explicit_acc time3;
};
