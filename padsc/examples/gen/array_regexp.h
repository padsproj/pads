#ifndef __ARRAY_REGEXP__H__
#define __ARRAY_REGEXP__H__
#include "pads.h"
...
Pread_res_t seq_t_final_checks (P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep,Ploc_t *loc_ptr,Pregexp_t *separator_regexp_ptr,Pregexp_t *terminator_regexp_ptr,int foundTerm,int consume);

Pread_res_t seq_t_read_one_init (P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep,Ploc_t *loc_ptr,Pregexp_t *separator_regexp_ptr,Pregexp_t *terminator_regexp_ptr);

Pread_res_t seq_t_read_one (P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep,Ploc_t *loc_ptr,Pbase_pd *elt_pd,Pint32 *elt_rep,Pregexp_t *separator_regexp_ptr,Pregexp_t *terminator_regexp_ptr);

Perror_t seq_t_read (P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep);

Pread_res_t seq_t_reread_one (Pregexp_t *separator_regexp_ptr,Pregexp_t *terminator_regexp_ptr,P_t *pads,seq_t_m *m,seq_t_pd *pd,seq_t *rep,Ploc_t *loc_ptr,Pbase_pd *elt_pd,Pint32 *elt_rep,int notFirstElt);
