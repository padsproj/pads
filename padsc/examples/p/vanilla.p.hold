...
Ptypedef Pstring_ME(:"/([0-9A-Za-z][A-Za-z0-9_\\-]*)@((([0-9A-Za-z][A-Za-z0-9_\\-]*)\\.)+([0-9A-Za-z][A-Za-z0-9_\\-]*))/":) PPemail;
...
Ptypedef Pstring_ME(:"/(http|ftp|https):\\/\\/((([0-9A-Za-z][A-Za-z0-9_\\-]*)\\.)+([0-9A-Za-z][A-Za-z0-9_\\-]*))(:([1-9][0-9]*))?\\/?(\\/([^\\/\\\\?*:<>\"\\[\\] ]+))*\\/?(\\?)?\\&?([^&=]+=[^&]*(\\&[^&=]+=[^&]*)*\\&?)?(#([0-9A-Za-z][A-Za-z0-9_\\-]*))?|(http|ftp|https):\\/\\/(([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3}))(:([1-9][0-9]*))?\\/?(\\/([^\\/\\\\?*:<>\"\\[\\] ]+))*\\/?(\\?)?\\&?([^&=]+=[^&]*(\\&[^&=]+=[^&]*)*\\&?)?(#([0-9A-Za-z][A-Za-z0-9_\\-]*))?/":) PPurl;

Ptypedef Pstring_ME(:"/((([0-9A-Za-z][A-Za-z0-9_\\-]*)\\.)+(com|net|edu|org|gov)(\\.[a-z][a-z])?)/":) PPhostname;
